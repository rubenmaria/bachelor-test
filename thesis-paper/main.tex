...
\begin{definition}{Backpropagation}
  ...
  der Kettenregel:
    ...
    \[ \Delta W_{j,i}^{(l)} = -\eta \cdot o_i  \cdot \delta_j^{(l)} \]
    wobei $\eta > 0$ die Lernrate ist, die festlegt wie schnell 
    die Gewichte in Richtung des Minimums
    ...
    nähern sich die Gewichte einen Minimum der Loss Function.
\end{definition}
\hfill
\\\\
