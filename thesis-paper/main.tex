...
\begin{figure}[H]
  ...
  \end{center}
  \caption{
      Transformer-Architektur entommen aus \cite{vaswani2023attentionneed}. 
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{
    SBERT-Architektur entnommen aus \cite{reimers2019sentencebertsentenceembeddingsusing}. 
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Extrahierung eines Kontexts aus einer C-Quellcode}
\end{figure}
