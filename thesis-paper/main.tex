...
Funktionsnamen zugeordnet werden kann. \\
Mit diesen Anpassungen die noch zusammen gefügt werden mussten konnte nun
Trainiert werden und nach Abschluss des Trainings konnten die semantischen
...
Also die selben Ergebnisse für Java auch für C-Quellcode zu produzieren.
...
semantische Vektoren. Auch der kleine Datensatz mit $n = ?$ Datenpunkten,
...
gewisse Inforamtionen des Namens wiederspiegeln.
