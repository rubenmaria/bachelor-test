...
\end{definition}
Hierfür muss vorher definiert werden, inwiefern zwei Objekte
ähnlich sind und welchen Abstandsbegriff man im Vektorraum wählt.
...
Folglich muss das Wort, das in dem gegebenen Kontext verwendet wird, prädiziert werden.
...
SBERT muss für zwei Sätze vorhersagen, ob sie sich inhaltlich
...
mit $85 \%$ und $859$ GB Speicherplatz,
...
mit $8 \%$ und $78$ GB Speicherplatz, besteht aus natürlicher Sprache, in der es um 
...
Der kleinste Teil im Datensatz mit $7 \%$ und $3.5$ TB Speicherplatz 
...
$40 \%$ mehr Tokens von je nach Modell $1.0-1.4$ T zu $2.0$ T.
...
\begin{figure}[H]
  ...
  \caption{
    Die \textit{t-SNE} Vektoren, mit unterschiedlichen Perplexity-Parameter,
    produziert aus den hochdimensionalen
    Funktionskommentar-Embeddings. Hier gibt es, wie im letzten Abschnitt
...
mit $P = 30$ abgebildet, um sie qualitativ zu vergleichen.
\begin{figure}[H]
  \begin{center}
    \begin{tikzpicture}
      \begin{groupplot}[
