...
von BERT's Output in einen semantischen Vektor. In dem Paper werden drei 
verschiedene pooling Strategien vorgestellt. Die erste ist den ersten Ouputvektor
zu nehmen der zum \verb|[cls]| Token korrespondiert und zum klassifizieren 
bestimmter aussagen über den Input genutzt wird. Die zweite ist den Mittelwert
aller Outputvektoren zu nehmen und die letzt ist 
