...
\section{Ergebnisse}
Um die Frage zu beantworten welche der vorgestellten strategien 
(Funktionsnamen, Funktionskommentare, \textit{Code2Vec} und 
Code-Llama-Erklärungen)
zu erzeugung
von Quellcode-Embeddings, die besten semantischen Embeddings liefern, wurden
drei verschiedene Evaluierungsmehtoden verwendet. 
% Vorgehensweise
