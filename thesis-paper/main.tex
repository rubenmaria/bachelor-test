...
von BERT's Output in einen semantischen Vektor. Das in dem Paper verwendete
defualt pooling ist der Mittelwert, d.h. auf alle Ouputvektoren von BERT,
wird komponentenweise das arithmetische Mittel angewendet. Desweiteren wird
...
2024 entwickelt. Large Language Models sind Modelle welche sich daraus
auszeichnen, natürliche Sprache gernerieren zu können oder in der Lage sind
andere schwierige NLP aufgaben zu lösen.
...
zu kommen, auf einen Datensatz der aus drei verschieden kategorien von Daten
besteht trainiert. Der größte Teil im Datensatz mit $85\%$, ist der mit
...
neuren Daten Trainiert und verwendet $40\%$ mehr mögliche Tokens.
Deweiteren wurde die {\bf context lenght} verdoppelt, welche die maximale
Anzahl der zu verabeitende Token beschreibt. Außerdem gab es eine große
veränderung in der Architektur, 
