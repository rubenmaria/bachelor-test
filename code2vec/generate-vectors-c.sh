INPUT_DIR=$1
OUTPUT_NAME=$2
MODEL_PATH=models/c2vec-glibc/saved_model_iter84.release
MODEL_DIRECTORY=models/c2vec-glibc/
MAX_CONTEXTS=200
...
rm ${TRAIN_DATA_FILE} ${VAL_DATA_FILE} ${TEST_DATA_FILE} \
	...
	${OUTPUT_NAME}.train.c2v ${OUTPUT_NAME}.val.c2v ${OUTPUT_NAME}.dict.c2v ${OUTPUT_NAME}.test.c2v.num_examples ${OUTPUT_NAME}.test.c2v
